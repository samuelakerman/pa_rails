...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { brandeis_id: @instructor.brandeis_id, email: @instructor.email, fname: @instructor.fname, lname: @instructor.lname, type: @instructor.type } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { brandeis_id: @instructor.brandeis_id, email: @instructor.email, fname: @instructor.fname, lname: @instructor.lname, type: @instructor.type } }
